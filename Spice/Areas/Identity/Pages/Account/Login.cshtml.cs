        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    List<ShoppingCart>lstShopppingCart = await _db.ShoppingCart.Where(u => u.ApplicationUserId ==user.Id).ToListAsync();    
                    HttpContext.Session.SetInt32(SD.ssShoppingCartCount,lstShopppingCart.Count);
