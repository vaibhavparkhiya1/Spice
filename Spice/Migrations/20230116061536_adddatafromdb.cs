...
{
    /// <inheritdoc />
    public partial class adddatafromdb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CouponsType = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponsCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CouponsDiscount = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_MenuItems_MenuItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_MenuItemsId",
                table: "OrderDetails",
                column: "MenuItemsId");
